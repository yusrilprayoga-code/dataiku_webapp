...
const RightSidebar: React.FC<RightSidebarProps> = ({ activeButton }) => {
  ...
  const qualityControlButtons: string[] = ['HISTOGRAM', 'CROSSPLOT D-N', 'CROSSPLOT GR-N', 'TRIM DATA', 'SPLICING/MERGING', 'DEPTH MATCHING', 'FILL MISSING', 'SMOOTHING', 'NORMALIZATION'];
