						...
						<table className="min-w-full text-sm table-auto">
							...
							<tbody className="bg-white">
								{parameters.map((param) => (
									<tr
										key={param.id}
										className={`border-b border-gray-200 ${getRowBgColor(
											param.location,
											param.mode
										)}`}>
										...
										{displayColumns.map((column) => {
											...
											// PERBAIKAN: Logika yang lebih robust untuk menentukan apakah input ini adalah dropdown log.
											const isLogInput =
