...
export default function GsaBaseParams({ moduleTitle, apiEndpoint, relevantParams }: GsaBaseParamsProps) {
    ...
    // Gunakan relevantParams dari props untuk inisialisasi parameter
    useEffect(() => { 
        setParameters(createInitialParameters(selectedIntervals, relevantParams)); 
    }, [selectedIntervals, relevantParams]);
