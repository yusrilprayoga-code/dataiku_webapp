...
import FillMissingDashboardParams from "@/features/fill_missing/FillMissing";
...
const ErrorComponent = ({ moduleName }: { moduleName: string }) => (
	<div className="h-full p-4 md:p-6 bg-gray-50">
		<div className="p-4 border rounded-lg bg-red-50 text-red-700">
			...
			<p>
				Parameter form for &quot;{moduleName}&quot; not found or not registered.
			</p>
			<button
...
const moduleMap: Record<string, React.ComponentType<unknown>> = {
	...
	"rt-ro": RtRoPage,
	swgrad: SwgradParams,
	"fill-missing": FillMissingDashboardParams,
